...
浏览器类型：
	<select id="browser">
		...
		<option value="">Android browser</option>
...
<div id="mainBar"
	...
	var myChart;
		...
		function test()
		{
			...
			var ardown=[1,1,1];
			var artotal=[1,1,1]; */
			$.ajax({url:"FlowServlet",type:"GET",success:function(msg){
				/* var xx=eval('('+msg+')');
				ar=xx.data1; */
				
				var ar=msg.brand;
				var ar2=msg.listData;
				var ardown=msg.listData1;
				var artotal=msg.listData2;
